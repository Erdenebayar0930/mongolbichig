...
## ⚠ Нэг апп, хоёр гадаргуу — деплойд нөлөөлөх зүйлс

Репо одоо **хоёр бүтээгдэхүүнийг нэг Next апп**-аар үйлчилдэг (дэлгэрэнгүйг
...
hPanel → Environment variables хэсэгт дараахыг **нэмнэ** (утгыг
...
Facebook бот нь монгол бичгийн зургийг `public/fonts/mongol/*.ttf`-ээс уншдаг
(fontconfig нь WOFF2 уншдаггүй тул TTF хувилбар тэнд зэрэг хэвтэнэ).
`output: "standalone"` нь `public/`-ыг `server.js`-ийн хажууд **автоматаар
хуулдаггүй**.

Хуулагдаагүй тохиолдолд зураг нь **алдаа шидэхгүй** — үсгийн оронд дөрвөлжин
хайрцаг зурчихна. Тиймээс [mongolPoster.ts](../src/lib/site/mongolPoster.ts) нь
эхний зурагдалт дээр фонтоо шалгаж, олдохгүй бол `[mongol]` угтвартай алдаа
логонд бичнэ. Деплойн дараа `/api/bichig?text=сайн` хаягийг нэг удаа дуудаж,
зураг нь зөв гарч байгааг нүдээр шалгах нь хамгийн хурдан баталгаа.
